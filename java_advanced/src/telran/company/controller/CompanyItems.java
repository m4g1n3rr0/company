...
public class CompanyItems {
    ...
    static Set<String> departments = new HashSet<>(Arrays.asList("Development", "QA", "Audit", "Accounting", "Management", "Sales"));
    ...
    private static void getEmployeesBySalary(InputOutput io) {
    	...
    	int salaryFrom = io.readInt("Enter salary from", "Wrong salary value", MIN_SALARY, MAX_SALARY - 1);
		int salaryTo = io.readInt("Enter salary to", "Wrong salary value", salaryFrom + 1, MAX_SALARY);
